...
#bean$beanperpod <- ifelse(bean$beanperpod == 0 & bean$pollinator != "Closed", NA, bean$beanperpod)
boxplot(bean$beanperpod ~ bean$pollinator, las = 1)
